...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,                  KC_TRNS,    KC_TRNS,     KC_TRNS,     KC_TRNS,  KC_TRNS,  KC_TRNS,
                    QK_BOOT,  KC_TRNS,  MO(_LOWER), KC_TRNS,   KC_TRNS,                 KC_TRNS,    KC_TRNS,     MO(_RAISE),  KC_TRNS,  QK_BOOT
    ),
    ...
    [_LOWER] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,                  KC_MINS,    KC_TRNS,  RALT_T(KC_LBRC), RSFT_T(KC_RBRC), RCTL_T(KC_BSLS), KC_EQL,
        KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,                  KC_UNDS,    KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_BSLS,  KC_TILD,
                    QK_BOOT,  KC_TRNS,  MO(_LOWER), KC_TRNS,  KC_TRNS,                  KC_TRNS,    KC_TRNS,   MO(_RAISE), KC_TRNS,  QK_BOOT
    ),
    ...
    [_ADJUST] = LAYOUT_split_3x6_5(
        ...
        KC_F1,      KC_F2,    KC_F3,    KC_F4,      KC_F5,    KC_F6,                    KC_F7,      KC_1,     KC_2,       KC_3,   KC_F11,   KC_F12,
